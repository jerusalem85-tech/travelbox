...
const breadcrumbLabels = {
  ...
  knowledge: 'قاعدة المعرفة', complaints: 'الشكاوى', 'gift-vouchers': 'قسائم هدايا',
  campaigns: 'الحملات', 'loyalty-points': 'نقاط الولاء', gallery: 'المعرض',
...
export default function Layout() {
  ...
  { section: 'العمليات', id: 'operations', links: [
    ...
    { to: '/loyalty-points', icon: 'stars', label: 'نقاط الولاء' },
  ...
  { section: 'الإدارة', id: 'admin', links: [
    { to: '/exec-dashboard', icon: 'speedometer2', label: 'لوحة التنفيذية' },
