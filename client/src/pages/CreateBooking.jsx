...
export default function CreateBooking() {
  ...
  const [form, setForm] = useState({
    customer_id: '', service_type: '', travel_date: '', return_date: '',
    from_destination: '', to_destination: '', airline: '', flight_number: '',
    ticket_number: '', status: 'pending', total_amount: 0, cost_amount: 0, notes: ''
  });
  ...
  return (
    <div>
      <h5 className="page-title mb-3">حجز جديد</h5>
      <div className="card">
          ...
          <form onSubmit={handleSubmit}>
            <div className="row g-3">
              ...
              <div className="col-md-6">
                ...
                <input className="form-control" value={form.service_type} onChange={e => setForm({...form, service_type: e.target.value})} placeholder="مثال: تذكرة طيران، فندق" />
              </div>
            ...
            <div className="mt-3">
              ...
              <button type="button" className="btn btn-outline-secondary me-2" onClick={() => navigate('/bookings')}>إلغاء</button>
            </div>
          </form>
        </div>
      </div>
